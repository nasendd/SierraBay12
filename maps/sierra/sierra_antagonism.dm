...
/datum/antagonist/changeling
	...
	restricted_jobs = list(/datum/job/captain, /datum/job/hop, /datum/job/hos, /datum/job/detective, /datum/job/warden, /datum/job/officer,     )

/datum/antagonist/godcultist
	blacklisted_jobs = list(/datum/job/ai, /datum/job/cyborg, /datum/job/chaplain, /datum/job/submap)
	restricted_jobs = list(/datum/job/captain, /datum/job/hop, /datum/job/hos, /datum/job/detective, /datum/job/warden, /datum/job/officer, /datum/job/iaa, /datum/job/iso,     )
