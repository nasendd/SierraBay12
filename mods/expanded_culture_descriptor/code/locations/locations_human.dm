...
/singleton/cultural_info/location/quig
	...
	economic_power = 1.2
	secondary_langs = list(LANGUAGE_HUMAN_EURO, LANGUAGE_RESOMI, LANGUAGE_SIMPSKRELLIAN, LANGUAGE_HUMAN_CHINESE, LANGUAGE_HUMAN_ARABIC, LANGUAGE_HUMAN_INDIAN, LANGUAGE_HUMAN_IBERIAN, LANGUAGE_HUMAN_RUSSIAN)
