/obj/item/stock_parts/computer/hard_drive/portable/plantgene
	disk_name = "plant gene disk"
	rarity_value = 40
	spawn_tags = SPAWN_TAG_PLANT_GENE_DISK
	spawn_blacklisted = TRUE	// Trade beacons or off-ship loot
	bad_type = /obj/item/stock_parts/computer/hard_drive/portable/plantgene	// Base type has no gene info
	price_tag = 50
	var/trait_info
	var/preset_genetype
	var/list/preset_values = list()

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/Initialize()
...
// BIOCHEMISTRY
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/biochemistry
	preset_genetype = GENE_BIOCHEMISTRY
	bad_type = /obj/item/stock_parts/computer/hard_drive/portable/plantgene/biochemistry

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/biochemistry/potency
	disk_name = "plant gene disk - potency: 50"	// Needed for vendor names
	trait_info = "potency: 50"
	preset_values = list(TRAIT_POTENCY = 50)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/biochemistry/potency_high
	disk_name = "plant gene disk - potency: 100"
	trait_info = "potency: 100"
	preset_values = list(TRAIT_POTENCY = 100)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/biochemistry/potency_max
	disk_name = "plant gene disk - potency: 200"
	trait_info = "potency: 200"
	preset_values = list(TRAIT_POTENCY = 200)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/biochemistry/psilocybin
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/biochemistry/mutagen
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/biochemistry/cleaner
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/biochemistry/eznutrient
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/biochemistry/left4zed
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/biochemistry/robustharvest
...
// ATMOSPHERE
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/atmos
	preset_genetype = GENE_ATMOSPHERE
	bad_type = /obj/item/stock_parts/computer/hard_drive/portable/plantgene/atmos

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/atmos/low_kpa_tolerance
	disk_name = "plant gene disk - low pressure: 40"
	trait_info = "low pressure: 40"
	preset_values = list(TRAIT_LOWKPA_TOLERANCE = 40)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/atmos/high_kpa_tolerance
	disk_name = "plant gene disk - high pressure: 160"
	trait_info = "high pressure: 160"
	preset_values = list(TRAIT_HIGHKPA_TOLERANCE = 160)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/atmos/heat_tolerance
	disk_name = "plant gene disk - heat tolerance: 70"
	trait_info = "heat tolerance: 70"
	preset_values = list(TRAIT_HEAT_TOLERANCE = 70)

// ENVIRONMENT
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/environment
	preset_genetype = GENE_ENVIRONMENT
	bad_type = /obj/item/stock_parts/computer/hard_drive/portable/plantgene/environment

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/environment/ideal_heat
	disk_name = "plant gene disk - ideal heat: 273 K"
	trait_info = "ideal heat: 273 K"
	preset_values = list(TRAIT_IDEAL_HEAT = 273)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/environment/light_tolerance
	disk_name = "plant gene disk - light tolerance: 10"
	trait_info = "light tolerance: 10"
	preset_values = list(TRAIT_LIGHT_TOLERANCE = 10)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/environment/ideal_light
	disk_name = "plant gene disk - ideal light: 10"
	trait_info = "ideal light: 10"
	preset_values = list(TRAIT_IDEAL_LIGHT = 10)

// HARDNIESS
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/hardiness
	preset_genetype = GENE_HARDINESS
	bad_type = /obj/item/stock_parts/computer/hard_drive/portable/plantgene/hardiness

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/hardiness/toxins_tolerance
	disk_name = "plant gene disk - toxins tolerance: 7"
	trait_info = "toxins tolerance: 7"
	preset_values = list(TRAIT_TOXINS_TOLERANCE = 7)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/hardiness/pest_tolerance
	disk_name = "plant gene disk - pest tolerance: 7"
	trait_info = "pest tolerance: 7"
	preset_values = list(TRAIT_PEST_TOLERANCE = 7)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/hardiness/weed_tolerance
	disk_name = "plant gene disk - weed tolerance: 7"
	trait_info = "weed tolerance: 7"
	preset_values = list(TRAIT_WEED_TOLERANCE = 7)

// METABOLISM
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/metabolism
	preset_genetype = GENE_METABOLISM
	bad_type = /obj/item/stock_parts/computer/hard_drive/portable/plantgene/metabolism

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/metabolism/no_nutrients_water
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/metabolism/requires_nutrients
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/metabolism/requires_water
	disk_name = "plant gene disk - requires water: TRUE"
	trait_info = "requires water: TRUE"
	preset_values = list(TRAIT_REQUIRES_WATER = 1)

// DIET
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/diet
	preset_genetype = GENE_DIET
	bad_type = /obj/item/stock_parts/computer/hard_drive/portable/plantgene/diet

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/diet/carnivorous
	disk_name = "plant gene disk - carnivorous"
	trait_info = "carnivorous"
	preset_values = list(TRAIT_CARNIVOROUS = 1)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/diet/noncarnivorous
	disk_name = "plant gene disk - non-carnivorous"
	trait_info = "non-carnivorous"
	preset_values = list(TRAIT_CARNIVOROUS = 0)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/diet/parasitic
	disk_name = "plant gene disk - parasitic"
	trait_info = "parasitic"
	preset_values = list(TRAIT_PARASITE = 1)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/diet/nonparasitic
	disk_name = "plant gene disk - non-parasitic"
	trait_info = "non-parasitic"
	preset_values = list(TRAIT_PARASITE = 0)

// VIGOUR
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour
	preset_genetype = GENE_VIGOUR
	bad_type = /obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour/yield
	disk_name = "plant gene disk - yield: 5"
	trait_info = "yield: 5"
	preset_values = list(TRAIT_YIELD = 5)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour/yield_high
	disk_name = "plant gene disk - yield: 10"
	trait_info = "yield: 10"
	preset_values = list(TRAIT_YIELD = 10)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour/yield_max
	disk_name = "plant gene disk - yield: 15"
	trait_info = "yield: 15"
	preset_values = list(TRAIT_YIELD = 15)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour/production
	disk_name = "plant gene disk - production: 5"
	trait_info = "production: 5"
	preset_values = list(TRAIT_PRODUCTION = 5)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour/production_high
	disk_name = "plant gene disk - production: 3"
	trait_info = "production: 3"
	preset_values = list(TRAIT_PRODUCTION = 3)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour/production_max
	disk_name = "plant gene disk - production: 1"
	trait_info = "production: 1"
	preset_values = list(TRAIT_PRODUCTION = 1)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour/maturation
	disk_name = "plant gene disk - maturation: 5"
	trait_info = "maturation: 5"
	preset_values = list(TRAIT_MATURATION = 5)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour/maturation_fast
	disk_name = "plant gene disk - maturation: 3"
	trait_info = "maturation: 3"
	preset_values = list(TRAIT_MATURATION = 3)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour/maturation_faster
	disk_name = "plant gene disk - maturation: 1"
	trait_info = "maturation: 1"
	preset_values = list(TRAIT_MATURATION = 1)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour/spreading
	disk_name = "plant gene disk - spreading: 1"
	trait_info = "spreading: 1"
	preset_values = list(TRAIT_SPREAD = 1)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour/vine_spreading
	disk_name = "plant gene disk - spreading: 2"
	trait_info = "spreading: 2"
	preset_values = list(TRAIT_SPREAD = 2)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour/not_spreading
	disk_name = "plant gene disk - spreading: 0"
	trait_info = "spreading: 0"
	preset_values = list(TRAIT_SPREAD = 0)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour/wall_hugger
	disk_name = "plant gene disk - wall growth"
	trait_info = "wall growth"
	preset_values = list(TRAIT_WALL_HUGGER = 1)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/vigour/non_wall_hugger
	disk_name = "plant gene disk - no wall growth"
	trait_info = "no wall growth"
	preset_values = list(TRAIT_WALL_HUGGER = 0)

// STRUCTURE
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/structure
	preset_genetype = GENE_STRUCTURE
	bad_type = /obj/item/stock_parts/computer/hard_drive/portable/plantgene/structure

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/structure/repeat_harvest
	disk_name = "plant gene disk - repeatable harvest"
	trait_info = "repeatable harvest"
	preset_values = list(TRAIT_HARVEST_REPEAT = 1)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/structure/single_harvest
	disk_name = "plant gene disk - single harvest"
	trait_info = "single harvest"
	preset_values = list(TRAIT_HARVEST_REPEAT = 0)

// OUTPUT
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/output
	preset_genetype = GENE_OUTPUT
	bad_type = /obj/item/stock_parts/computer/hard_drive/portable/plantgene/output

// Power
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/output/power_producer
	disk_name = "plant gene disk - power production: on"
	trait_info = "power production: on"
	preset_values = list(TRAIT_PRODUCES_POWER = 1)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/output/not_power_producer
	disk_name = "plant gene disk - power production: off"
	trait_info = "power production: off"
	preset_values = list(TRAIT_PRODUCES_POWER = 0)

// Light
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/output/bioluminescent_off
	disk_name = "plant gene disk - bioluminescence: off"
	trait_info = "bioluminescence: off"
	preset_values = list(TRAIT_BIOLUM = 0)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/output/bioluminescent_dimmer
	disk_name = "plant gene disk - bioluminescence: 1"
	trait_info = "bioluminescence: 1"
	preset_values = list(TRAIT_BIOLUM = 1)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/output/bioluminescent_dim
	disk_name = "plant gene disk - bioluminescence: 2"
	trait_info = "bioluminescence: 2"
	preset_values = list(TRAIT_BIOLUM = 2)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/output/bioluminescent_normal
	disk_name = "plant gene disk - bioluminescence: 3"
	trait_info = "bioluminescence: 3"
	preset_values = list(TRAIT_BIOLUM = 3)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/output/bioluminescent_bright
	disk_name = "plant gene disk - bioluminescence: 4"
	trait_info = "bioluminescence: 4"
	preset_values = list(TRAIT_BIOLUM = 4)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/output/bioluminescent_brighter
	disk_name = "plant gene disk - bioluminescence: 5"
	trait_info = "bioluminescence: 5"
	preset_values = list(TRAIT_BIOLUM = 5)

// PIGMENT
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/pigment
	preset_genetype = GENE_PIGMENT
	bad_type = /obj/item/stock_parts/computer/hard_drive/portable/plantgene/pigment

// Light
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/pigment/red
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/pigment/orange
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/pigment/green
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/pigment/cyan
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/pigment/blue
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/pigment/purple
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/pigment/red_dark
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/pigment/orange_dark
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/pigment/green_dark
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/pigment/cyan_dark
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/pigment/blue_dark
...
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/pigment/purple_dark
...
// SPECIAL
/obj/item/stock_parts/computer/hard_drive/portable/plantgene/special
	preset_genetype = GENE_SPECIAL
	bad_type = /obj/item/stock_parts/computer/hard_drive/portable/plantgene/special

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/special/immutable
	disk_name = "plant gene disk - immutable"
	trait_info = "immutable"
	preset_values = list(TRAIT_IMMUTABLE = 1)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/special/mutable
	disk_name = "plant gene disk - mutable"
	trait_info = "mutable"
	preset_values = list(TRAIT_IMMUTABLE = 0)

/obj/item/stock_parts/computer/hard_drive/portable/plantgene/special/highly_mutable
