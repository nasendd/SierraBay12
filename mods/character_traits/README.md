...
- https://github.com/SierraBay/SierraBay12/pull/2777
<!--
...
Добавляет простой список для выбора особенностей персонажа, не отсносящимся к лоадауту, внешности, органам или к культуре.
<!--
...
### Оверрайды
 ...
 - `/mods/character_traits/character_traits.dm`:
 - `/datum/preferences/mod_traits`
